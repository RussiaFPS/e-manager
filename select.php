<?php
    ...
    $result_select = $mysql->query("SELECT * FROM `list_card` WHERE `viewer_name`='$selected2'");
        ...
        if($id_card2 != $id_card1 and $role_selected2 != $role_selected1 and $status=='YES'){
    ...
    $result_select = $mysql->query("SELECT * FROM `list_card` WHERE `viewer_name`='$selected3'");
            ...
            if($id_card3 != $id_card1 and $id_card3 != $id_card2 and $role_selected3 != $role_selected1 and $role_selected3 != $role_selected2 and $status=='YES'){
    ...
    $result_select = $mysql->query("SELECT * FROM `list_card` WHERE `viewer_name`='$selected4'");
                ...
                if($id_card4 != $id_card1 and $id_card4 != $id_card2 and $id_card4 != $id_card3 and $role_selected4 != $role_selected1 and $role_selected4 != $role_selected2 and $role_selected4 != $role_selected3 and $status=='YES'){
    ...
    $result_select = $mysql->query("SELECT * FROM `list_card` WHERE `viewer_name`='$selected5'");
                    ...
                    if($id_card5 != $id_card1 and $id_card5 != $id_card2 and $id_card5 != $id_card3 and $id_card5 != $id_card4 and $role_selected5 != $role_selected1 and $role_selected5 != $role_selected2 and $role_selected5 != $role_selected3 and $role_selected5 != $role_selected4 and $status=='YES'){
